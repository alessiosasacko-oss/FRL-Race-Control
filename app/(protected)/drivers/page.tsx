        ...
        <section className="data-table-shell" aria-label="FRL Fahrerfeld">
          ...
          {drivers.map((driver) => (
            ...
            >
              ...
              <span className="min-w-0"><span className="flex items-center gap-2"><CountryFlag countryCode={driver.countryCode} fallbackFlag={driver.flag} size="sm" /><span className="truncate font-bold text-white">{driver.name}</span></span><span className="mt-1 block text-xs font-bold uppercase tracking-[0.12em] text-blue-300">{driver.league ? `FRL ${driver.league.code}` : "Ohne aktuelle Liga"}</span></span>
