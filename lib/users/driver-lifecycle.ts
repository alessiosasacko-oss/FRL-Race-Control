...
const driverLabels: Record<keyof DriverHistoricalDependencyCounts, string> = {
  ...
  attendanceAudits: "historische Terminprotokolle",
  adjustments: "Meisterschaftsanpassungen",
  fiaTickets: "historische Fallbeteiligungen",
  penaltyProposals: "Strafenvorschläge",
  decisions: "historische Entscheidungen",
};

const userLabels: Record<keyof UserHistoricalDependencyCounts, string> = {
  reportedTickets: "erstellte historische Fälle",
  archivedTickets: "historische Archivierungen",
  stewardAssignments: "historische Fallzuweisungen",
  evidence: "hochgeladene Beweismittel",
  fiaAuditEntries: "historische Fallprotokolle",
  discussionMessages: "historische Fallnachrichten",
  mentions: "Chat-Erwähnungen",
  votes: "historische Abstimmungen",
  ...
  decisionMemberships: "historische Entscheidungszuordnungen",
  attendanceSubmissions: "historische Terminmeldungen",
  attendanceAudits: "historische Terminänderungen",
