        ...
        {transactions.map((transaction) => (
          <article key={transaction.id} className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/45 p-4">
            ...
            <dl className="mt-4 grid grid-cols-2 gap-3 text-xs">
              <div><dt className="text-slate-500">Kontext</dt><dd className="mt-1 text-slate-300">FRL {transaction.league.code} · {transaction.season.name}</dd></div>
